...
class Serial3_to_CID():
    ...
    def calcCidChecksum(self, cidmsg):
        '''
    ...
    def queueCIDmsg(self, account: str, event_code: str, partition: str, zone: str, restore: bool, mType='18') -> str:
        """
        ...
        if len(account) == 4 and account.isnumeric()       \
            ...
            cidMsg = account + \
                    mType + \
                    ('1' if (restore != True) else '3') + event_code + \
                    partition + \
                    zone
